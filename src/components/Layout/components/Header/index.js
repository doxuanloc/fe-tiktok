...
function Header() {
  ...
  return (
    <header className={styles["wrapper-hello"]}>
      <div className={styles["inner"]}>
        <div onClick={getHome} className={styles["logo"]}>
          ...
          {currentUser ? (
            <>
              <Tippy delay={[0, 50]} content="Upload Video">
                <button className={styles["icon-upload"]}>
                  <FontAwesomeIcon icon={faCloudUploadAlt} />
                </button>
              </Tippy>
              <Tippy delay={[0, 50]} content="Message">
                <button className={styles["icon-mess"]}>
                  <FontAwesomeIcon icon={faMessage} />
                </button>
              </Tippy>
              <Tippy delay={[0, 50]} content="Inbox">
                <button className={styles["icon-inbox"]}>
                  <FontAwesomeIcon icon={faInbox} />
                </button>
              </Tippy>

              <Menu
                items={currentUser ? userMenu : MENU_LANG}
                onChange={handleMenuChange}
              >
                <img
                  className={styles["user-avt"]}
                  alt="Nam Ngu"
                  src="https://p16-sign-sg.tiktokcdn.com/aweme/100x100/tos-alisg-avt-0068/98cb5a941c6ae617e9f0ce13a76178bc.jpeg?x-expires=1655121600&x-signature=xxmnpBkYltalJkhri9E8qdZI0vU%3D"
                />
              </Menu>
            </>
          ) : (
